...
|Harold Mayta|<ul>Mejorar e implementacion de BC Profiel</ul>|
...
|---|---|---|
|Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto eningeniería.|**Valentino Cervantes**<br>TB1:Durante el proceso de creación de los mapas de empatia, persona y diagrama de clases, pude reconocer diversos factores dentro del negocio que son importantes idas las cuales pudimos conversarlo en reuniones.<br>TP:Durante el proceso de creacion de los wireframes de Hisotrial de viajes y el desarrollo del componente se pudo apreciar la importancia de un diseño inteligente y coherente respetando las buenas practicas y conveniencias de este<br>TB2:<br>Realicé mejoras en las vistas del apartado FrontEnd y también incorporé la lógica del núcleo del negocio.<br><br>TF:<br>Durante el desarrollo del front se tuvo quw tener en cuenta los multiples entregables del curso asi como una metodologia definida<br>**Salvador Chamorro**<br>TB1:<br>Durante esta primera etapa del proyecto ha sido de mucha importancia la comunicacion activa tanto entre integrantes del proyecto como con los clientes, y gracias a esto hemos podido empezar con un proyecto bien estructurado y autosostenible.<br>TP:<br>En el desarrollo del TP he participado en las reuniones programadas, he aportado con ideas y posibles soluciones de diferentes imprevistos y sobre todo he tratado de buscar siempre una comunicacion asertiva para poder encontrar los mejores resultados para el proyecto.<br>TB2:<br>En esta segunda parte del proyecto, se realizaron reuniones donde se converso acerca de la parte backend del proyecto y como gestionariamos correctamente el tiempo.<br><br>TF:<br>En esta parte final, se completo la parte del FrontEnd y BackEnd. Ademas, nos juntamos para poder realizar el despliegue de los diferentes items y tener en lo posible el proyecto completo.<br>**Diego Huincho**<br>TB1:<br>Durante el proceso de desarrollo de prototipos para nuestros clientes, he reconocido la importancia fundamental de comprender sus necesidades y deseos. Esta comprensión se ha fortalecido a través de conversaciones significativas con mis compañeros, donde intercambiamos ideas y perspectivas para generar soluciones innovadoras y centradas en el cliente.<br>TP:<br>Durante el avance del TP participo en reuniones con el equipo para discutir el progreso del desarrollo y posibles soluciones que implementar. <br>TB2:<br>Durante esta entrega se implementó los features en lenguaje gherkin de los user stories, ademas se implemento mas paginas en el frontend para la web del proyecto.<br>TF:<br>Para la entrega final nos reunimos como equipo en daiyl meetings para tener organizadas nuestras tareas.<br>**Harold Mayta**<br>TB1:<br>Se realizo reuniones con el objetivo de planificar la ruta de trabajo asi como el desarrollo de las sentrevistas a nuestro futuro publico objetivo. Se participo activamente en lluvia de ideas para claer los planes de servicio y la linea de trabajo.<br>TP:Facilito las sesiones y la organización de cada tarea asociada manteniendo una comunicacion permanente con el grupo,<br>TB2:<br>Durante esta entrega se logró establecer el perfil BC desde el backend, además de coordinar eficientemente la organización de tareas y la programación de reuniones.<br>TF:<br>Se logro exponer todo lo requerido por parte del profesor para esta entrega en el tf asi mismo en la exposicion se logro expresar lo mejor posible lo logrado en el curso.<br>**Nicolas Vera**<br>TB1:<br>Durante el proceso de desarrollo de nuestra prototipo para nuestro futuros clientes, he terminado comprendiedno la importancia que tiene sus necesidades y deseos.Ademas, esta comprension ha mejorado gracias a distirnas charlas y reuniones que he tenido con mis compañeros de trabajo con la finalidad de poder presentar una solucion innovadora para los clientes.<br>TP:<br>Durante el desarrollo del TP, he participado activamente en reuniones regulares con el equipo para evaluar y discutir el progreso del proyecto, así como para identificar posibles soluciones a los desafíos que surgieron durante el proceso de desarrollo. Estas reuniones han sido fundamentales para mantenernos alineados en nuestros objetivos y asegurar que estamos en el camino correcto para lograr los resultados deseados.<br>TB2:<br>Durante esta fase del proyecto, he participado activamente en las reuniones programadas, contribuyendo con ideas y soluciones para diversos imprevistos. Además, he ayudado a establecer el login desde el frontend y una fakeApi y he coordinado de manera eficiente la organización de tareas y la programación de reuniones, siempre procurando mantener una comunicación asertiva para lograr los mejores resultados para el proyecto.<br>TF:<br>Durante esta fase del proyecto, he participado activamente en las reuniones programadas, contribuyendo con ideas y soluciones para diversos imprevistos. Además, he ayudado en el ruteo de las distintas pantallas, he agregado más endpoints al fakeApi y he desarrollado nuevas pantallas. También he coordinado de manera eficiente la organización de tareas y la programación de reuniones, siempre procurando mantener una comunicación asertiva para lograr los mejores resultados para el proyecto.<br>|La comunicación oral ha sido efectiva dentro del equipo, permitiendo un intercambio fluido de ideas y una comprensión compartida de los objetivos del proyecto. Se continuará fomentando esta comunicación para mantener la colaboración y el progreso del trabajo.|
|Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto en ingeniería.|**Valentino Cervantes**<br>TB1:Este enfoque de grupo me permitió compartir ideas y en general establecer un marco de trabajo colaborativo eficiente dado que pude tener retroalimentaciones de cada parte que hacia.<br>TP:Durante el proceso de creacion de los wireframes de Hisotrial de viajes y el desarrollo del componente se pudo apreciar la importancia de un diseño inteligente y coherente respetando las buenas practicas y conveniencias de este<br><br>TB2:<br>Realicé mejoras en las vistas del apartado FrontEnd y también incorporé la lógica del núcleo del negocio.<br>TF:<br>En esta entrega se implemento las pantallas faltantes al frontend como el user profile y se arreglo errores de estilos generales<br>**Salvador Chamorro**<br>TB1:<br>Gracias al correcto trabajo en equipo hemos podido lograr todos los objetivos propuestos que nos han llevado a lograr esta primera etapa del proyecto.<br>TP:<br> Para el TP hemos buscado la mejor forma para organizarnos y realizar las tareas asgignadas en las reuniones, donde todos hemos aportado y hemos encontrado acuerdos para un correcto desarrollo del proyecto. Todas estas tareas estan estrechamente relacionadas con el codigo y estructura del proyecto orientada al dominio.<br>TB2:<br>En esta segunda parte del proyecto, se utilizo el product backlog y los diagramas de bounded context para generar el backend.<br>TF:<br>En esta parte final, se implementaron mejoras tanto en el backend como en el frontend para poder tener el proyecto funcional.<br>**Diego Huincho**<br>TB1:<br>Este enfoque colaborativo nos ha permitido crear prototipos que no solo satisfacen las expectativas de nuestros clientes, sino que también superan sus expectativas al ofrecer soluciones que realmente resuelven sus problemas y agregan valor a sus vidas.<br>TP:<br>Diseñó la interfaz de usuario cuando se encuentre en el menu principal de la web aplication y la interfaz de usuario para la visualización de planes de servicio.<br>TB2:<br>Durante esta entrega se implementó los features en lenguaje gherkin de los user stories, ademas se implemento mas paginas en el frontend para la web del proyecto.<br>TF:<br>En esta parte final, se implementaron mejoras tanto en el backend como en el frontend para poder tener el proyecto funcional.<br>**Harold Mayta**<br>TB1:<br>Se realizo la separacionde trabajos de acuerdo a las competencias de cada integrante, se diseño la entrevista para nuestro publico objetivo, tambien la redaccion de los capitulos relacionados a la implementacion, valdacion. Se participo activamente del diseño de producto.<br>TP:Preparó informes de planificación del proyecto brindando seguimiento de los avances,recomendacione e implementaciones para mejorar la eficienci y la calidad del proyecto.<br>TB2:<br>Durante esta entrega se logró establecer el perfil BC desde el backend, además de coordinar eficientemente la organización de tareas y la programación de reuniones.<br>TF:<br>Durante el proyecto de ingeniería, desarrollé habilidades clave en la comunicación escrita de ideas y resultados para diferentes especialidades y niveles jerárquicos. Contribuí al desarrollo backend con ASP.NET Core, creando controladores y operaciones CRUD. Redacté el informe final del proyecto y elaboré una presentación clara y concisa. Estas actividades mejoraron mis habilidades en comunicación técnica, desarrollo backend y trabajo en equipo, contribuyendo al éxito del proyecto y a mi desarrollo profesional.<br>**Nicolas Vera**<br>TB1:<br>Gracias al correcto trabajo en equipo que hemos realizado nos ha permitido crear un prototipo que supera las expectativas de nuestros clientes; ya que ofrecemos soluciones innovadoras que resuelven problemas que son evidenciados en la actualidad.<br>TP:<br>Diseñó y desarrollo la interfaz de usuario cuando quiera iniciar sesion en la web aplication; diseñó y desarrollo la interfaz de usuario cuando quiera registrarse como usuario en la web aplication y realizo la mayoria de los routeos de los componentes de las web aplication.<br>TB2:<br>Realicé mejoras en las vistas del apartado FrontEnd y también incorporé la lógica del núcleo del negocio. Además, de añadir un db.json y una fakeApi.<br>TF:<br>Realice mas endpoint en el db.json, cree nuevos métodos post y get en el fakeApi, agregue mas pantallas. Además, mejore el ruteo e implemente lógica de programación para saber cuando es un pasajero o un conductor.<br>|La comunicación escrita ha sido crucial para documentar el progreso del proyecto y asegurar la comprensión de los entregables entre los miembros del equipo. Se seguirá manteniendo un enfoque claro y conciso en la comunicación escrita para garantizar la eficacia y la calidad del trabajo.|
...
![Evidencia](images/sprint4-front1.jpg)
![Evidencia](images/sprint4-front2.jpg)
![Evidencia](images/sprint4-front3.jpg)
![Evidencia](images/sprint4-front4.jpg)
![Evidencia](images/sprint4-front5.jpg)
...
En cuanto al Deployment de este producto para este sprint 4, se desplegó nuestro FrontEnd mediante Netlify y el BackEnd mediante Azure.

![Evidencia](images/sprint4-deploy1.png)
![Evidencia](images/sprint4-deploy2.png)
![Evidencia](images/sprint4-deploy3.png)
...
Video en Microsoft Stream: https://upcedupe-my.sharepoint.com/:v:/g/personal/u202114851_upc_edu_pe/Ee_ZMrRfEjBLjR37VY1HAC0BFxu-Z-bpwAYQQfulND_Rzw?e=fNTaDz&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D

Duracion:10:18

![Evidencia](images/sprint4-about.png)
...
Link: https://upcedupe-my.sharepoint.com/:v:/g/personal/u202114851_upc_edu_pe/EZC66nWBS59Ipi3JrPAKngcBnlmqhJS4Q9x9FeM5WSHGHA?e=CbGH5f&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D	

![Evidencia](images/sprint4-team.png)
...
<br>
Link: https://upcedupe-my.sharepoint.com/:v:/g/personal/u202114851_upc_edu_pe/Ee_ZMrRfEjBLjR37VY1HAC0BFxu-Z-bpwAYQQfulND_Rzw?e=fNTaDz&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D
...
_FrontEnd_
<br>
Link: https://feature--unirider.netlify.app/

_BackEnd_
<br>
Link: (se encontro problemas para crear la base de datos se subira evidencia de dicho problemas)
